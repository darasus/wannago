      ...
      <ul className="flex flex-col gap-y-4 list-inside list-decimal">
        ...
        <li>
          <Text>
            ...
            manage events, invite guests, and communicate with their network. We
            provide tools to help users organize and plan their events, as well
            as features to help them stay connected with their guests.
          </Text>
        </li>
        <li>
          <Text>
            ...
            If you become aware of any unauthorized use of your account, please
        ...
        <li>
          <Text>
            ...
            submit any content that is obscene, offensive, or harmful to others.
            You may not use our Services in a manner that interferes with the
            operation of our platform or harms our reputation.
          </Text>
        </li>
        <li>
          <Text>
        ...
        <li>
          <Text>
            ...
            guarantee that our Services will be error-free or uninterrupted. You
        ...
        <li>
          <Text>
            Indemnification You agree to indemnify and hold us harmless from any
            claims, damages, or expenses arising out of your use of our Services
            or your violation of these Terms.
          </Text>
        </li>
        <li>
          <Text>
            Termination We may terminate your access to our Services at any time
            for any reason. Upon termination, your user account and all User
            Content will be deleted from our platform.
          </Text>
        </li>
        <li>
          <Text>
        ...
        <li>
          <Text>
            Changes to Terms and Conditions We reserve the right to modify these
            Terms at any time. Any changes will be posted to our website, and
            your continued use of our Services after such changes will
