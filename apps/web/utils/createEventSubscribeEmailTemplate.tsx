...
export function createEventSubscribeEmailTemplate(event: Event) {
  return template
    ...
    .replace('[[event.endTime]]', formatDate(event.endDate, 'yyyy/MM/dd hh:m'))
    .replace('[[event.address]]', event.address)
    .replace('[[event.url]]', `${getBaseUrl()}/e/${event.shortId}`);
}
            ...
            <tr>
              <td class="p-4 text-center">
                <a href="https://wannago.app">
                  <img src="https://wannago.app/images/logo_dark.png" width="100" alt="WannaGo" class="max-w-full align-middle border-0">
                </a>
              </td>
            </tr>
            <tr>
              <td align="center" class="sm-px-4">
                <table class="w-full" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="px-4 bg-white text-gray-800 text-base text-left leading-6 rounded-xl shadow-md">
                      <p>
                        You've been invited to:
                      </p>
                      <p class="text-2xl text-black font-semibold m-0 mb-4">
                        [[event.name]]
                      </p>
                      <p class="m-0">
                      ...
                      <p class="m-0">
                        Finishes: [[event.endTime]]
                      </p>
                      <p class="m-0">
                        Address: [[event.address]]
                      </p>
                      <div class="leading-full mt-4">
                        <a href="[[event.url]]" class="inline-block p-4 rounded text-base font-semibold text-center text-decoration-none text-white bg-indigo-700 hover-bg-indigo-500">
                          <!--[if mso]>
                            <i class="tracking-6 -mso-font-width-full mso-text-raise-7_5">&#8202;</i>
                          <![endif]-->
                          <span class="mso-text-raise-4">View event</span>
                          <!--[if mso]>
                  ...
                  <tr>
                    <td class="text-center text-slate-600 text-xs p-4">
                      <p class="m-0">
                        Powered by WannaGo
                      </p>
