...
export const handleEventSignUpInputSchema = baseEventHandlerSchema.extend({
  eventId: z.string().uuid(),
  userId: z.string().uuid(),
});

export async function handleEventSignUp({
  eventId,
  userId,
}: z.infer<typeof handleEventSignUpInputSchema>) {
